			...
			array(
				...
				'diffpoints' =>
					array(
						...
						'desc'       => __( 'Extra points a user gets for guessing the goal difference correct for a match. The shortcode [fp-diffpoints] adds this value in the content. This value is also used in the calculations in the pool.', 'football-pool' )
					),
				'diffpoints_rule' =>
					array(
						'id'         => 'diffpoints_rule',
						'label'      => __( 'Rules for the goal difference bonus', 'football-pool' ),
						'type'       => 'radiolist',
						'value_type' => 'integer',
						'options'    => array(
							array( 'value' => 0, 'text' => __( 'Only for toto scores, but no draws (classic rule)', 'football-pool' ) ),
							array( 'value' => 1, 'text' => __( 'Only for toto scores, and including draws', 'football-pool' ) ),
//							array( 'value' => 3, 'text' => __( 'For full scores and toto scores, but no draws', 'football-pool' ) ),
							array( 'value' => 2, 'text' => __( 'For full scores and toto scores, and including draws', 'football-pool' ) ),
						),
					),
				...
				'prediction_page_show_correct_question_answer' =>
					array(
						'type' => 'checkbox',
						'value_type' => 'integer',
						'label' => __( 'Show question answer', 'football-pool' ),
						'id' => 'prediction_page_show_correct_question_answer',
						'desc' => __( 'When checked the page will also show the answer for the question that was entered by the admin.', 'football-pool' )
					),
				...
				'frontend_ajax_saves' =>
					array(
						...
						'label'      => __( 'Asynchronous saves', 'football-pool' ),
						'type'       => 'checkbox',
						'value_type' => 'integer',
				...
				'enable_onunload_check' =>
					array(
						...
						'label'      => __( 'Check unsaved changes', 'football-pool' ),
						'type'       => 'checkbox',
						'value_type' => 'integer',
				...
				'erase_personal_data' =>
					array(
						...
						'label'      => __( 'Erase Personal Data', 'football-pool' ),
						'type'       => 'checkbox',
						'value_type' => 'integer',
				...
				'auto_select_current_user_for_stats' =>
					array(
						...
						'label'      => __( 'Charts include current user', 'football-pool' ),
						'type'       => 'checkbox',
						'value_type' => 'integer',
				...
				'default_prediction_0' =>
					array(
						...
						'label'      => __( 'Fix incomplete predictions', 'football-pool' ),
						'type'       => 'checkbox',
						'value_type' => 'integer',
				...
				'shoutbox_notifications' =>
					array(
						'id'         => 'shoutbox_notifications',
						'label'      => __( 'Shoutbox notifications', 'football-pool' ),
						'type'       => 'checkbox',
						'value_type' => 'integer',
		...
		self::options_form(
			array(
				...
				$options['prediction_page_show_correct_question_answer'],

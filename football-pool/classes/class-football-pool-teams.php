...
class Football_Pool_Teams {
	public $teams;
	public array $team_types;
	public array $team_names;
	public array $team_flags;
	public $team_info;
	...
	// returns array with team values or null if no team found
	public function get_team_by_id( $id ): ?Football_Pool_Team
	{
	...
	/**
	 * Returns team object or null when no team name is given or no team found
	 *
	 * @param string $name
	 * @param string $addnew
	 ...
	 */
	public function get_team_by_name( string $name, string $addnew = 'no', array $extra_data = [] )
	{
		if ( $name === '' ) return null;
	 ...
	 * @return int
	 */
	public function get_group_order( $team ): int
	{

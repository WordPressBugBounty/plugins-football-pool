...
class Football_Pool_Ranking_Widget extends Football_Pool_Widget {
	...
	public function html( string $title, array $args, array $instance ) {
		...
		$league = ! empty( $instance['league'] ) ? (int) $instance['league'] : FOOTBALLPOOL_LEAGUE_ALL;
		$ranking_id = ! empty( $instance['ranking_id'] ) ? (int) $instance['ranking_id'] : FOOTBALLPOOL_RANKING_DEFAULT;
